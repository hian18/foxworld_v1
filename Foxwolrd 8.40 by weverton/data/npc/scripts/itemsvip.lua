...
function onCreatureSay(cid, type, msg)
  	...
  	if (msgcontains(msg, 'hi') and (focus == 0)) and getDistanceToCreature(cid) < 4 then
  		selfSay('Hello ' .. creatureGetName(cid) .. '! I\'m selling the VIP Set. My offers are: Divine Armor (4kk), Divine Legs (3kk), Divine Helmet (3kk), Eagle Shield (5kk) and Supreme Boots (2kk).')
  		focus = cid
  		talk_start = os.clock()
